...
if(isset($_POST['updateinfo']))
{
   ...
   $upqry = "UPDATE users SET `name` = '$name', `date` = '$dob', `language` = '$language', `country` = '$country' WHERE email = '$email'";
                  ...
                  <div class="iq-card-body profile-page">
                     <div class="profile-header">
                        <div class="cover-container text-center">
                           <img src="upload/<?php echo $image; ?>" height="80px" width="100px" alt="profile-bg" class="rounded-circle img-fluid" >
