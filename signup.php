...
session_start();
  ...
  if(isset($_POST['signup']))
  {
    ...
    else
    {
      ...
      $qry = "INSERT INTO `users` (`user_id`, `name`, `email`, `password`, `date`, `language`,`country`,`type`,`image`) VALUES ('$user_id', '$name', '$email', '$password', '$date','$language', '$country','user','user.jpg');";
                  ...
                  <div class="sign-user_card ">                    
                     <div class="sign-in-page-data">
                        ...
                        <div class="sign-in-from w-100 m-auto">
                            ...
                            <center>
                              <h6>ONLY TAKES 10 SECONDS!  </h6>
                              <h6>ENJOY MORE FEATURES NOW!</h6>
                            </center>
                            
                            <form class="mt-4" action="" method="post" enctype="multipart/form-data">
                              <div class="form-group">                                 
                                 <input type="text" class="form-control mb-0" name="name" placeholder="Enter User Name" required>
                              </div>
                              <div class="form-group">                                 
                                 <input type="email" class="form-control mb-0" name="email" placeholder="Enter email" required>
                              </div>
                              <div class="form-group">                                 
                                 <input type="password" class="form-control mb-0" name="password" placeholder="Password" required>
                              </div> 
                              <div class="form-group">                                 
                                 <input type="date" class="form-control mb-0" name="date" required>
                              </div>
                              
                              <div class="form-group">                                 
                                  <select data-placeholder="Choose a Language..." name="language" class="form-control mb-0" required>
   ...
   <option value="Zimbabwe">Zimbabwe</option>
                     ...
                     <div class="mt-3">
                        <div class="d-flex justify-content-center links">
                           ALREADY HAVE AN ACCOUNT? <a href="signin.php" class="text-primary ml-2">SIGN IN</a>
                        </div>                        
                     </div>
                  </div>
               </div>
